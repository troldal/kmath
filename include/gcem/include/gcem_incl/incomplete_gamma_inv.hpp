...
template <typename T>
constexpr T
incomplete_gamma_inv_initial_val_1(const T a, const T t_val,
...
template <typename T>
constexpr T
incomplete_gamma_inv_initial_val_2(const T a, const T p,
                                   const T t_val) noexcept { // a <= 1.0
  return (p < t_val ?                                        // if
              pow(p / t_val, T(1) / a)
                    :
                    // else
...
template <typename T>
constexpr T incomplete_gamma_inv_err_val(const T value, const T a,
