...
template <typename T> constexpr T erf_cf_large_main(const T x) noexcept {
...
template <typename T> constexpr T erf_cf_small_main(const T x) noexcept {
...
template <typename T> constexpr T erf_begin(const T x) noexcept {
  return (x > T(2.1) ? // if
              erf_cf_large_main(x)
                     :
                     // else
...
template <typename T> constexpr T erf_check(const T x) noexcept {
  return ( // NaN check
