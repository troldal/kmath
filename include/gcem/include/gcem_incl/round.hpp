...
template <typename T> constexpr T round_int(const T x) noexcept {
...
template <typename T> constexpr T round_check_internal(const T x) noexcept {
  return x;
}
...
round_check_internal<long double>(const long double x) noexcept {
...
template <typename T> constexpr T round_check(const T x) noexcept {
  return ( // NaN check
