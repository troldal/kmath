...
// $CXX -O3 -Wall -std=c++11 -fconstexpr-depth=650 -fconstexpr-steps=1271242
// -I./../include sqrt.cpp -o sqrt.test -framework Accelerate
...
int main() {
  ...
  GCEM_TEST_COMPARE_VALS(gcem::sqrt, std::sqrt,
