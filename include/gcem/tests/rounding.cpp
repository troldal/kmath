...
int main() {
  ...
  GCEM_TEST_COMPARE_VALS(gcem::floor, std::floor,
  ...
  GCEM_TEST_COMPARE_VALS(gcem::ceil, std::ceil,
                         std::numeric_limits<float>::max());
  GCEM_TEST_COMPARE_VALS(gcem::ceil, std::ceil,
                         -std::numeric_limits<long double>::infinity());
  GCEM_TEST_COMPARE_VALS(gcem::ceil, std::ceil,
  ...
  GCEM_TEST_COMPARE_VALS(gcem::trunc, std::trunc,
                         std::numeric_limits<float>::max());
  GCEM_TEST_COMPARE_VALS(gcem::trunc, std::trunc,
                         -std::numeric_limits<long double>::infinity());
  GCEM_TEST_COMPARE_VALS(gcem::trunc, std::trunc,
  ...
  GCEM_TEST_COMPARE_VALS(gcem::round, std::round,
                         std::numeric_limits<float>::max());
  GCEM_TEST_COMPARE_VALS(gcem::round, std::round,
                         -std::numeric_limits<long double>::infinity());
  GCEM_TEST_COMPARE_VALS(gcem::round, std::round,
