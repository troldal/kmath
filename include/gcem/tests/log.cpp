...
// g++-mp-7 -O3 -Wall -std=c++11 -fconstexpr-depth=20 -fconstexpr-steps=1271242
// -I./../include log.cpp -o log.test -framework Accelerate
...
int main() {
  ...
  GCEM_TEST_COMPARE_VALS(gcem::log, std::log,
